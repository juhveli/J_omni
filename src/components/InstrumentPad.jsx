...
const KEY_MAPPINGS_SIMPLE = {
  'a': 0, 's': 1, 'd': 2, 'f': 3, 'g': 4, 'h': 5, 'j': 6, 'k': 7, 'l': 8
};

const KEY_MAPPINGS_FULL = {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (currentInstrument === 'drums' || currentScale === 'simple') {
        index = KEY_MAPPINGS_SIMPLE[key] !== undefined ? KEY_MAPPINGS_SIMPLE[key] : -1;
      } else if (currentScale === 'full') {
        index = KEY_MAPPINGS_FULL[key] !== undefined ? KEY_MAPPINGS_FULL[key] : -1;
      }
