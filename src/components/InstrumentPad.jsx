...
const InstrumentPad = ({ currentScale, currentInstrument }) => {
  ...
  // TODO: [Feature] WebRTC Collaboration: Share `activeNotes` state via WebRTC to allow multiple users to play the instrument pad simultaneously over the network.
  let notes;
