...
class ComfyUIClient {
    ...
    async generateAudio(params) {
        ...
        const phaseStep0 = 2 * Math.PI * freq0 * invSampleRate;
        const phaseStep1 = 2 * Math.PI * freq1 * invSampleRate;
        ...
        for (let i = 0; i < bufferLength; i++) {
            ...
            data0[i] = Math.sin(i * phaseStep0) * amp;
            data1[i] = Math.sin(i * phaseStep1) * amp;
        }
